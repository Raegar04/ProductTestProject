...
namespace EAWebApp.Producer
{
    ...
    {
        private readonly swaggerConfigClient _productApiClient;

        public ProductUtil() => _productApiClient = new swaggerConfigClient("https://localhost:44334", new HttpClient());
